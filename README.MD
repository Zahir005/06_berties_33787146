...
Zoi — 14/02/2025, 00:29
Zoi — 14/02/2025, 00:36
Attachment file type: acrobat
Computing Project Report.pdf
6.91 MB
Zoi — 12/11/2025, 16:16
.
Zoi
 started a call that lasted an hour. — 12/11/2025, 16:16
Zoi — 12/11/2025, 16:24
Add Book
Zoi — 12/11/2025, 16:39
name="keyword"
zahir — 12/11/2025, 16:53
Bertie’s Books
...
Node.js + Express
EJS templating
CSS (served from public/main.css)
(Optional) MySQL/SQLite demo scripts in /*.sql for a books table
Project Structure
berties-books/
├── public/
│   └── main.css
├── routes/
│   ├── books.js        # /books and book-related routes (add/list/etc.)
│   ├── main.js         # site-wide pages (/, /about, etc.)
│   └── users.js        # user demo routes (e.g., /register)
├── views/
│   ├── about.ejs
│   ├── addbook.ejs
│   ├── bargainbooks.ejs
...
https://github.com/Zahir005/06_berties_33787146/edit/master/README.MD
GitHub
...
2 KB
Zoi
 started a call that lasted 7 minutes. — Yesterday at 19:55
Zoi
 started a call that lasted 25 minutes. — Yesterday at 20:02
Zoi — Yesterday at 20:18
README.md
Zoi
 started a call. — 10:43
zahir — 10:48
# Bertie’s Books
A tiny Express web app for a fictional book shop. It renders EJS templates, serves static assets, and demonstrates simple CRUD patterns (list books, add a book, basic search).
